...
@Component({
  selector: 'app-dialog',
  templateUrl: './dialog-with-last-focusable-element.component.html',
  styleUrls: ['./dialog-with-last-focusable-element.component.css']
})
export class DialogWithLastFousAbleElementComponent implements AfterViewInit, OnDestroy {
